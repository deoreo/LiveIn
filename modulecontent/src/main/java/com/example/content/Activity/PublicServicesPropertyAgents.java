...
import com.example.content.Adapter.PublicServicesPropertyAgentsAdapter;
 ...
 */
public class PublicServicesPropertyAgents extends AppCompatActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Property Agents");
        ...
        PublicServicesPropertyAgentsAdapter adapter = new PublicServicesPropertyAgentsAdapter(this,
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
        ...
        switch (position) {
            case 0:
                ...
                Intent intent_property0 = new Intent(getApplicationContext(), PublicServicesPropertyAgentsDetail.class);
                startActivity(intent_property0);
                break;
            case 1:
                /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_property1 = new Intent(getApplicationContext(), PublicServicesPropertyAgentsDetail.class);
                startActivity(intent_property1);
                break;
            case 2:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_property2 = new Intent(getApplicationContext(), PublicServicesPropertyAgentsDetail.class);
                startActivity(intent_property2);
                break;
            case 3:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_property3 = new Intent(getApplicationContext(), PublicServicesPropertyAgentsDetail.class);
                startActivity(intent_property3);
                break;
            case 4:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_property4 = new Intent(getApplicationContext(), PublicServicesPropertyAgentsDetail.class);
                startActivity(intent_property4);
                break;
            case 5:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_property5 = new Intent(getApplicationContext(), PublicServicesPropertyAgentsDetail.class);
                startActivity(intent_property5);
                break;
            case 6:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_property6 = new Intent(getApplicationContext(), PublicServicesPropertyAgentsDetail.class);
                startActivity(intent_property6);
                break;
        }
