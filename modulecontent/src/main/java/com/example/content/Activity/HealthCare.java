...
import com.example.content.Adapter.HealthCareAdapter;
 ...
 */
public class HealthCare extends AppCompatActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        HealthCareAdapter adapter = new HealthCareAdapter(this,
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
        ...
        switch (position) {
            case 0:
                ...
                Intent intent_health0 = new Intent(getApplicationContext(), HealthCareDetail.class);
                startActivity(intent_health0);
                break;
            case 1:
                /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_health1 = new Intent(getApplicationContext(), HealthCareDetail.class);
                startActivity(intent_health1);
                break;
            case 2:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_health2 = new Intent(getApplicationContext(), HealthCareDetail.class);
                startActivity(intent_health2);
                break;
            case 3:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_health3 = new Intent(getApplicationContext(), HealthCareDetail.class);
                startActivity(intent_health3);
                break;
            case 4:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_health4 = new Intent(getApplicationContext(), HealthCareDetail.class);
                startActivity(intent_health4);
                break;
            case 5:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_health5 = new Intent(getApplicationContext(), HealthCareDetail.class);
                startActivity(intent_health5);
                break;
            case 6:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_health6 = new Intent(getApplicationContext(), HealthCareDetail.class);
                startActivity(intent_health6);
                break;
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.search) {
            ...
            Intent intent_health_care = new Intent(HealthCare.this, Home.class);
