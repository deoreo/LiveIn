...
import com.example.content.Adapter.DiningFastAdapter;
 ...
 */
public class DiningFast extends AppCompatActivity implements
        AdapterView.OnItemClickListener {

    private static final String TAG = DiningFast.class.getSimpleName();

    private List<SubCategoryModel> dinList = new ArrayList<SubCategoryModel>();
    private ListView listView;
    private DiningFastAdapter adapter;
    private Toolbar bar;
    ...
    private void initListView() {
        ...
        adapter = new DiningFastAdapter(this, dinList);
...
<<<<<<< HEAD
        switch (position) {
            ...
            case 6:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_fast6 = new Intent(getApplicationContext(), DiningFastDetail.class);
                startActivity(intent_fast6);
                break;
        }
...
//        }
        ...
        Intent intent = new Intent(DiningFast.this, DiningFastDetail.class);
