...
import com.example.content.Adapter.EducationAdapter;
 ...
 */
public class Education  extends AppCompatActivity implements
...
/*        final Spinner spinner = (Spinner) findViewById(R.id.spinner);
        ...
        EducationAdapter adapter = new EducationAdapter(this,
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
        ...
        switch (position) {
            case 0:
                ...
                Intent intent_education0 = new Intent(getApplicationContext(), EducationDetail.class);
                startActivity(intent_education0);
                break;
            case 1:
                /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_education1 = new Intent(getApplicationContext(), EducationDetail.class);
                startActivity(intent_education1);
                break;
            case 2:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_education2 = new Intent(getApplicationContext(), EducationDetail.class);
                startActivity(intent_education2);
                break;
            case 3:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_education3 = new Intent(getApplicationContext(), EducationDetail.class);
                startActivity(intent_education3);
                break;
            case 4:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_education4 = new Intent(getApplicationContext(), EducationDetail.class);
                startActivity(intent_education4);
                break;
            case 5:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_education5 = new Intent(getApplicationContext(), EducationDetail.class);
                startActivity(intent_education5);
                break;
            case 6:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_education6 = new Intent(getApplicationContext(), EducationDetail.class);
                startActivity(intent_education6);
                break;
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.search) {
            ...
            Intent intent_education = new Intent(Education.this, Home.class);
