...
import com.example.content.Adapter.PublicServicesSPBUAdapter;
 ...
 */
public class PublicServicesSPBU extends AppCompatActivity implements
...
/*        final Spinner spinner = (Spinner) findViewById(R.id.spinner);
        ...
        PublicServicesSPBUAdapter adapter = new PublicServicesSPBUAdapter(this,
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
        ...
        switch (position) {
            case 0:
                ...
                Intent intent_spbu0 = new Intent(getApplicationContext(), PublicServicesSPBUDetail.class);
                startActivity(intent_spbu0);
                break;
            case 1:
                /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_spbu1 = new Intent(getApplicationContext(), PublicServicesSPBUDetail.class);
                startActivity(intent_spbu1);
                break;
            case 2:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_spbu2 = new Intent(getApplicationContext(), PublicServicesSPBUDetail.class);
                startActivity(intent_spbu2);
                break;
            case 3:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_spbu3 = new Intent(getApplicationContext(), PublicServicesSPBUDetail.class);
                startActivity(intent_spbu3);
                break;
            case 4:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_spbu4 = new Intent(getApplicationContext(), PublicServicesSPBUDetail.class);
                startActivity(intent_spbu4);
                break;
            case 5:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_spbu5 = new Intent(getApplicationContext(), PublicServicesSPBUDetail.class);
                startActivity(intent_spbu5);
                break;
            case 6:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_spbu6 = new Intent(getApplicationContext(), PublicServicesSPBUDetail.class);
                startActivity(intent_spbu6);
                break;
        }
