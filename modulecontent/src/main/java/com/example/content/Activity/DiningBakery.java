...
import com.example.content.Adapter.DiningBakeryAdapter;
import com.example.content.Adapter.DiningBarAdapter;
 ...
 */
public class DiningBakery extends AppCompatActivity implements
        AdapterView.OnItemClickListener {

    private static final String TAG = DiningBar.class.getSimpleName();


    private List<SubCategoryModel> dinList = new ArrayList<SubCategoryModel>();
    private ListView listView;
    private DiningBakeryAdapter adapter;
    private Toolbar bar;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Bakery");
    ...
    private void sendRequest() {
        ...
        JsonArrayRequest stringRequest = new JsonArrayRequest(AppConfig.URL_DINING + "10",
    ...
    private void initListView() {
        ...
        adapter = new DiningBakeryAdapter(this, dinList);
...
//                Intent intent_bakery0 = new Intent(getApplicationContext(), DiningBakeryDetail.class);
//                startActivity(intent_bakery0);
//                break;
//            case 1:
//                /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
//                Intent intent_bakery1 = new Intent(getApplicationContext(), DiningBakeryDetail.class);
//                startActivity(intent_bakery1);
//                break;
//            case 2:
//               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
//                Intent intent_bakery2 = new Intent(getApplicationContext(), DiningBakeryDetail.class);
//                startActivity(intent_bakery2);
//                break;
//            case 3:
//               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
//                Intent intent_bakery3 = new Intent(getApplicationContext(), DiningBakeryDetail.class);
//                startActivity(intent_bakery3);
//                break;
//            case 4:
//               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
//                Intent intent_bakery4 = new Intent(getApplicationContext(), DiningBakeryDetail.class);
//                startActivity(intent_bakery4);
//                break;
//            case 5:
//               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
//                Intent intent_bakery5 = new Intent(getApplicationContext(), DiningBakeryDetail.class);
//                startActivity(intent_bakery5);
//                break;
//            case 6:
//               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
//                Intent intent_bakery6 = new Intent(getApplicationContext(), DiningBakeryDetail.class);
//                startActivity(intent_bakery6);
//                break;
//        }
        ...
        Intent intent = new Intent(DiningBakery.this, DiningBakeryDetail.class);
