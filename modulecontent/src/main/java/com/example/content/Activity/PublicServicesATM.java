...
import com.example.content.Adapter.PublicServicesATMAdapter;
 ...
 */
public class PublicServicesATM extends AppCompatActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("ATM Gallery");
        ...
        PublicServicesATMAdapter adapter = new PublicServicesATMAdapter(this,
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
        ...
        switch (position) {
            case 0:
                ...
                Intent intent_atm0 = new Intent(getApplicationContext(), PublicServicesATMDetail.class);
                startActivity(intent_atm0);
                break;
            case 1:
                /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_atm1 = new Intent(getApplicationContext(), PublicServicesATMDetail.class);
                startActivity(intent_atm1);
                break;
            case 2:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_atm2 = new Intent(getApplicationContext(), PublicServicesATMDetail.class);
                startActivity(intent_atm2);
                break;
            case 3:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_atm3 = new Intent(getApplicationContext(), PublicServicesATMDetail.class);
                startActivity(intent_atm3);
                break;
            case 4:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_atm4 = new Intent(getApplicationContext(), PublicServicesATMDetail.class);
                startActivity(intent_atm4);
                break;
            case 5:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_atm5 = new Intent(getApplicationContext(), PublicServicesATMDetail.class);
                startActivity(intent_atm5);
                break;
            case 6:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_atm6 = new Intent(getApplicationContext(), PublicServicesATMDetail.class);
                startActivity(intent_atm6);
                break;
        }
