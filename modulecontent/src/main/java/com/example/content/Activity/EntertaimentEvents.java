...
public class EntertaimentEvents extends AppCompatActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        EntertaimentEventsAdapter adapter = new EntertaimentEventsAdapter(this,
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
        ...
        switch (position) {
            case 0:
                ...
                Intent intent_events0 = new Intent(getApplicationContext(), EntertaimentEventsDetail.class);
                startActivity(intent_events0);
                break;
            case 1:
                /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_events1 = new Intent(getApplicationContext(), EntertaimentEventsDetail.class);
                startActivity(intent_events1);
                break;
            case 2:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_events2 = new Intent(getApplicationContext(), EntertaimentEventsDetail.class);
                startActivity(intent_events2);
                break;
            case 3:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_events3 = new Intent(getApplicationContext(), EntertaimentEventsDetail.class);
                startActivity(intent_events3);
                break;
            case 4:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_events4 = new Intent(getApplicationContext(), EntertaimentEventsDetail.class);
                startActivity(intent_events4);
                break;
            case 5:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_events5 = new Intent(getApplicationContext(), EntertaimentEventsDetail.class);
                startActivity(intent_events5);
                break;
            case 6:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_events6 = new Intent(getApplicationContext(), EntertaimentEventsDetail.class);
                startActivity(intent_events6);
                break;
        }
