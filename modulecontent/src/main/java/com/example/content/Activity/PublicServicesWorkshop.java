...
import com.example.content.Adapter.PublicServicesWorkshopAdapter;
 ...
 */
public class PublicServicesWorkshop extends AppCompatActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Workshop Service");
        ...
        PublicServicesWorkshopAdapter adapter = new PublicServicesWorkshopAdapter(this,
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
        ...
        switch (position) {
            case 0:
                ...
                Intent intent_workshop0 = new Intent(getApplicationContext(), PublicServicesWorkshopDetail.class);
                startActivity(intent_workshop0);
                break;
            case 1:
                /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_workshop1 = new Intent(getApplicationContext(), PublicServicesWorkshopDetail.class);
                startActivity(intent_workshop1);
                break;
            case 2:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_workshop2 = new Intent(getApplicationContext(), PublicServicesWorkshopDetail.class);
                startActivity(intent_workshop2);
                break;
            case 3:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_workshop3 = new Intent(getApplicationContext(), PublicServicesWorkshopDetail.class);
                startActivity(intent_workshop3);
                break;
            case 4:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_workshop4 = new Intent(getApplicationContext(), PublicServicesWorkshopDetail.class);
                startActivity(intent_workshop4);
                break;
            case 5:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_workshop5 = new Intent(getApplicationContext(), PublicServicesWorkshopDetail.class);
                startActivity(intent_workshop5);
                break;
            case 6:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_workshop6 = new Intent(getApplicationContext(), PublicServicesWorkshopDetail.class);
                startActivity(intent_workshop6);
                break;
        }
