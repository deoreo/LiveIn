 ...
 */
public class DiningBar extends AppCompatActivity implements
    ...
    private DiningBarAdapter adapter;
    private Toolbar bar;
    ...
    private void sendRequest() {
        ...
        JsonArrayRequest stringRequest = new JsonArrayRequest(AppConfig.URL_DINING + '8',
    ...
    private void initListView() {
        ...
        adapter = new DiningBarAdapter(this, dinList);
...
//                Intent intent_bar0 = new Intent(getApplicationContext(), DiningBarDetail.class);
//                startActivity(intent_bar0);
//                break;
//            case 1:
//                /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
//                Intent intent_bar1 = new Intent(getApplicationContext(), DiningBarDetail.class);
//                startActivity(intent_bar1);
//                break;
//            case 2:
//               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
//                Intent intent_bar2 = new Intent(getApplicationContext(), DiningBarDetail.class);
//                startActivity(intent_bar2);
//                break;
//            case 3:
//               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
//                Intent intent_bar3 = new Intent(getApplicationContext(), DiningBarDetail.class);
//                startActivity(intent_bar3);
//                break;
//            case 4:
//               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
//                Intent intent_bar4 = new Intent(getApplicationContext(), DiningBarDetail.class);
//                startActivity(intent_bar4);
//                break;
//            case 5:
//               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
//                Intent intent_bar5 = new Intent(getApplicationContext(), DiningBarDetail.class);
//                startActivity(intent_bar5);
//                break;
//            case 6:
//               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
//                Intent intent_bar6 = new Intent(getApplicationContext(), DiningBarDetail.class);
//                startActivity(intent_bar6);
//                break;
//        }
        ...
        Intent intent = new Intent(DiningBar.this, DiningBarDetail.class);
