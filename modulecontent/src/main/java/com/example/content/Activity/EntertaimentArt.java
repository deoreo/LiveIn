 ...
 */
public class EntertaimentArt extends AppCompatActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        EntertaimentArtAdapter adapter = new EntertaimentArtAdapter(this,
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
        ...
        switch (position) {
            case 0:
                ...
                Intent intent_art0 = new Intent(getApplicationContext(), EntertaimentArtDetail.class);
                startActivity(intent_art0);
                break;
            case 1:
                /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_art1 = new Intent(getApplicationContext(), EntertaimentArtDetail.class);
                startActivity(intent_art1);
                break;
            case 2:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_art2 = new Intent(getApplicationContext(), EntertaimentArtDetail.class);
                startActivity(intent_art2);
                break;
            case 3:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_art3 = new Intent(getApplicationContext(), EntertaimentArtDetail.class);
                startActivity(intent_art3);
                break;
            case 4:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_art4 = new Intent(getApplicationContext(), EntertaimentArtDetail.class);
                startActivity(intent_art4);
                break;
            case 5:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_art5 = new Intent(getApplicationContext(), EntertaimentArtDetail.class);
                startActivity(intent_art5);
                break;
            case 6:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_art6 = new Intent(getApplicationContext(), EntertaimentArtDetail.class);
                startActivity(intent_art6);
                break;
        }
