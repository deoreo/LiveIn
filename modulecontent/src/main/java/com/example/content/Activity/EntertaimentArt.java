...
public class EntertaimentArt extends AppCompatActivity implements
    ...
    // Log tag
    private static final String TAG = EntertaimentArt.class.getSimpleName();

    private List<SubCategoryModel> artList = new ArrayList<SubCategoryModel>();
    private ListView listView;
    private EntertaimentArtAdapter adapter;
    private Toolbar bar;
    ...
    private void initListView() {
        ...
        adapter = new EntertaimentArtAdapter(this, artList);
