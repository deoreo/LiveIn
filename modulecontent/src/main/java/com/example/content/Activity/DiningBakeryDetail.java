 ...
 */
public class DiningBakeryDetail extends AppCompatActivity {
...
//        get_distance = extras.getString("distance");
        ...
        getSupportActionBar().setTitle("Bakery Detail");
        ...
        btn_map.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DiningBakeryDetail.this, MapDetail.class);
...
//                        longitude=object.getString("longitude");
                ...
                // Add header row
                TableRow rowHeader = new TableRow(DiningBakeryDetail.this);

                String[] headerText={"MENU","HARGA"};
                for(String c:headerText) {
                    TextView tv = new TextView(DiningBakeryDetail.this);
                ...
                for(int i=0;i<menu.length;i++){
                    TableRow row = new TableRow(DiningBakeryDetail.this);
                    row.setLayoutParams(new TableLayout.LayoutParams(TableLayout.LayoutParams.MATCH_PARENT,
                            TableLayout.LayoutParams.WRAP_CONTENT));

                    for(String text:local_admin[i]) {
                        final TextView tv = new TextView(DiningBakeryDetail.this);
                        tv.setLayoutParams(new TableRow.LayoutParams(TableRow.LayoutParams.WRAP_CONTENT,
                                TableRow.LayoutParams.WRAP_CONTENT));
                        tv.setTextColor(Color.WHITE);
                        tv.setTextSize(16);
