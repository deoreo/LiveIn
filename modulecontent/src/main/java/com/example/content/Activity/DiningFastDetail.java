 ...
 */
public class DiningFastDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Fast Detail");
        ...
        btn_map.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DiningFastDetail.this, MapDetail.class);
...
//                        longitude=object.getString("longitude");
                ...
                // Add header row
                TableRow rowHeader = new TableRow(DiningFastDetail.this);

                String[] headerText={"MENU","HARGA"};
                for(String c:headerText) {
                    TextView tv = new TextView(DiningFastDetail.this);
                ...
                for(int i=0;i<menu.length;i++){
                    TableRow row = new TableRow(DiningFastDetail.this);
                    row.setLayoutParams(new TableLayout.LayoutParams(TableLayout.LayoutParams.MATCH_PARENT,
                            TableLayout.LayoutParams.WRAP_CONTENT));

                    for(String text:local_admin[i]) {
                        final TextView tv = new TextView(DiningFastDetail.this);
                        tv.setLayoutParams(new TableRow.LayoutParams(TableRow.LayoutParams.WRAP_CONTENT,
                                TableRow.LayoutParams.WRAP_CONTENT));
                        tv.setTextColor(Color.WHITE);
                        tv.setTextSize(16);
