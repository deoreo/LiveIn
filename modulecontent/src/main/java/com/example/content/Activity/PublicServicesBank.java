...
import com.example.content.Adapter.PublicServicesBankAdapter;
 ...
 */
public class PublicServicesBank extends AppCompatActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        PublicServicesBankAdapter adapter = new PublicServicesBankAdapter(this,
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
        ...
        switch (position) {
            case 0:
                ...
                Intent intent_bank0 = new Intent(getApplicationContext(), PublicServicesBankDetail.class);
                startActivity(intent_bank0);
                break;
            case 1:
                /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_bank1 = new Intent(getApplicationContext(), PublicServicesBankDetail.class);
                startActivity(intent_bank1);
                break;
            case 2:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_bank2 = new Intent(getApplicationContext(), PublicServicesBankDetail.class);
                startActivity(intent_bank2);
                break;
            case 3:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_bank3 = new Intent(getApplicationContext(), PublicServicesBankDetail.class);
                startActivity(intent_bank3);
                break;
            case 4:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_bank4 = new Intent(getApplicationContext(), PublicServicesBankDetail.class);
                startActivity(intent_bank4);
                break;
            case 5:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_spbu5 = new Intent(getApplicationContext(), PublicServicesBankDetail.class);
                startActivity(intent_spbu5);
                break;
            case 6:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_bank6 = new Intent(getApplicationContext(), PublicServicesBankDetail.class);
                startActivity(intent_bank6);
                break;
        }
