...
import com.example.content.Adapter.IndustryAdapter;
 ...
 */
public class Industry extends AppCompatActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        IndustryAdapter adapter = new IndustryAdapter(this,
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
        ...
        switch (position) {
            case 0:
                ...
                Intent intent_industry0 = new Intent(getApplicationContext(), IndustryDetail.class);
                startActivity(intent_industry0);
                break;
            case 1:
                /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_industry1 = new Intent(getApplicationContext(), IndustryDetail.class);
                startActivity(intent_industry1);
                break;
            case 2:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_industry2 = new Intent(getApplicationContext(), IndustryDetail.class);
                startActivity(intent_industry2);
                break;
            case 3:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_industry3 = new Intent(getApplicationContext(), IndustryDetail.class);
                startActivity(intent_industry3);
                break;
            case 4:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_industry4 = new Intent(getApplicationContext(), IndustryDetail.class);
                startActivity(intent_industry4);
                break;
            case 5:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_industry5 = new Intent(getApplicationContext(), IndustryDetail.class);
                startActivity(intent_industry5);
                break;
            case 6:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_industry6 = new Intent(getApplicationContext(), IndustryDetail.class);
                startActivity(intent_industry6);
                break;
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.search) {
            ...
            Intent intent_industry = new Intent(Industry.this, Home.class);
            startActivity(intent_industry);
