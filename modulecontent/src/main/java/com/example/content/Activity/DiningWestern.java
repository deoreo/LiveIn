...
import com.example.content.Adapter.DiningWesternAdapter;
 ...
 */
public class DiningWestern extends AppCompatActivity implements
        AdapterView.OnItemClickListener {

    private static final String TAG = DiningWestern.class.getSimpleName();

    private List<SubCategoryModel> dinList = new ArrayList<SubCategoryModel>();
    private ListView listView;
    private DiningWesternAdapter adapter;
    private Toolbar bar;
    ...
    private void sendRequest() {
        ...
        JsonArrayRequest stringRequest = new JsonArrayRequest(AppConfig.URL_DINING + '7',
    ...
    private void initListView() {
        ...
        adapter = new DiningWesternAdapter(this, dinList);
...
//                Intent intent_western0 = new Intent(getApplicationContext(), DiningWesternDetail.class);
//                startActivity(intent_western0);
//                break;
//            case 1:
//                /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
//                Intent intent_western1 = new Intent(getApplicationContext(), DiningWesternDetail.class);
//                startActivity(intent_western1);
//                break;
//            case 2:
//               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
//                Intent intent_western2 = new Intent(getApplicationContext(), DiningWesternDetail.class);
//                startActivity(intent_western2);
//                break;
//            case 3:
//               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
//                Intent intent_western3 = new Intent(getApplicationContext(), DiningWesternDetail.class);
//                startActivity(intent_western3);
//                break;
//            case 4:
//               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
//                Intent intent_western4 = new Intent(getApplicationContext(), DiningWesternDetail.class);
//                startActivity(intent_western4);
//                break;
//            case 5:
//               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
//                Intent intent_western5 = new Intent(getApplicationContext(), DiningWesternDetail.class);
//                startActivity(intent_western5);
//                break;
//            case 6:
//               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
//                Intent intent_western6 = new Intent(getApplicationContext(), DiningWesternDetail.class);
//                startActivity(intent_western6);
//                break;
//        }
        ...
        Intent intent = new Intent(DiningWestern.this, DiningJapaneseDetail.class);
