...
import com.example.content.Adapter.EntertaimentBeautyAdapter;
...
public class EntertaimentBeauty extends AppCompatActivity implements
    ...
    // Log tag
    private static final String TAG = EntertaimentBeauty.class.getSimpleName();

    private List<SubCategoryModel> artList = new ArrayList<SubCategoryModel>();
    private ListView listView;
    private EntertaimentBeautyAdapter adapter;
    private Toolbar bar;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Beauty");
    ...
    private void initListView() {
        ...
        adapter = new EntertaimentBeautyAdapter(this, artList);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        Intent intent = new Intent(EntertaimentBeauty.this, EntertaimentBeautyDetail.class);
