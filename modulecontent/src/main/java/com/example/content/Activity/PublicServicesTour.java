...
import com.example.content.Adapter.PublicServicesTourAdapter;
 ...
 */
public class PublicServicesTour extends AppCompatActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        PublicServicesTourAdapter adapter = new PublicServicesTourAdapter(this,
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
        ...
        switch (position) {
            case 0:
                ...
                Intent intent_tour0 = new Intent(getApplicationContext(), PublicServicesTourDetail.class);
                startActivity(intent_tour0);
                break;
            case 1:
                /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_tour1 = new Intent(getApplicationContext(), PublicServicesTourDetail.class);
                startActivity(intent_tour1);
                break;
            case 2:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_tour2 = new Intent(getApplicationContext(), PublicServicesTourDetail.class);
                startActivity(intent_tour2);
                break;
            case 3:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_tour3 = new Intent(getApplicationContext(), PublicServicesTourDetail.class);
                startActivity(intent_tour3);
                break;
            case 4:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_tour4 = new Intent(getApplicationContext(), PublicServicesTourDetail.class);
                startActivity(intent_tour4);
                break;
            case 5:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_tour5 = new Intent(getApplicationContext(), PublicServicesTourDetail.class);
                startActivity(intent_tour5);
                break;
            case 6:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_tour6 = new Intent(getApplicationContext(), PublicServicesTourDetail.class);
                startActivity(intent_tour6);
                break;
        }
