...
import com.example.content.Adapter.DiningKoreanAdapter;
 ...
 */
public class DiningKorean extends AppCompatActivity implements
...
/*        final Spinner spinner = (Spinner) findViewById(R.id.spinner);
        ...
        DiningKoreanAdapter adapter = new DiningKoreanAdapter(this,
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position,
        ...
        switch (position) {
            case 0:
                ...
                Intent intent_korean0 = new Intent(getApplicationContext(), DiningKoreanDetail.class);
                startActivity(intent_korean0);
                break;
            case 1:
                /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_korean1 = new Intent(getApplicationContext(), DiningKoreanDetail.class);
                startActivity(intent_korean1);
                break;
            case 2:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_korean2 = new Intent(getApplicationContext(), DiningKoreanDetail.class);
                startActivity(intent_korean2);
                break;
            case 3:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_korean3 = new Intent(getApplicationContext(), DiningKoreanDetail.class);
                startActivity(intent_korean3);
                break;
            case 4:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_korean4 = new Intent(getApplicationContext(), DiningKoreanDetail.class);
                startActivity(intent_korean4);
                break;
            case 5:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_korean5 = new Intent(getApplicationContext(), DiningKoreanDetail.class);
                startActivity(intent_korean5);
                break;
            case 6:
               /*Snackbar.make(listView, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                Intent intent_korean6 = new Intent(getApplicationContext(), DiningKoreanDetail.class);
                startActivity(intent_korean6);
                break;
        }
