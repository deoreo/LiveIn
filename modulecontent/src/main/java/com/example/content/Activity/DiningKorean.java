...
public class DiningKorean extends AppCompatActivity implements
    ...
    private static final String TAG = DiningKorean.class.getSimpleName();
    private List<SubCategoryModel> dinList = new ArrayList<SubCategoryModel>();
    private ListView listView;
    private DiningKoreanAdapter adapter;
    private Toolbar bar;
    ...
    private void sendRequest() {
        ...
        JsonArrayRequest stringRequest = new JsonArrayRequest(AppConfig.URL_DINING + '6',
    ...
    private void initListView() {
        ...
        adapter = new DiningKoreanAdapter(this, dinList);
...
//        }
        ...
        Intent intent = new Intent(DiningKorean.this, DiningKoreanDetail.class);
