...
public class AppConfig {
    ...
    public static String URL_DETAIL="http://192.168.0.23/smartcity/index.php/api/tenant/?action=detail&idTenant=2";
    public static String URL_DETAIL_DINING="http://192.168.0.46/SmartCity/api/tenant/?action=detail&idTenant=3";
}
