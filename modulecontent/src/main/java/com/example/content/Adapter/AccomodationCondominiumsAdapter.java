 ...
 */
public class AccomodationCondominiumsAdapter extends ArrayAdapter<SubCategoryItem> {

    Context context;

    public AccomodationCondominiumsAdapter(Context context, int resourceId,
