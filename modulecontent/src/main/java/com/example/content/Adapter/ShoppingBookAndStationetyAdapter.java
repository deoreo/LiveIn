 ...
 */
public class ShoppingBookAndStationetyAdapter extends ArrayAdapter<SubCategoryItem> {

    Context context;

    public ShoppingBookAndStationetyAdapter(Context context, int resourceId,
