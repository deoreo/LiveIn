...
import com.example.content.Activity.ShoppingRecommendedDetail;
 ...
 */
public class ShoppingRecommendedAdapter extends RecyclerView.Adapter<ShoppingRecommendedAdapter.ViewHolder> {

    List<RecommendedItem> Items;

    public ShoppingRecommendedAdapter() {
        super();
                ...
                public void onClick(View v) {
                    ...
                    switch (position){
                        case 0:
                            ...
                            Intent intent_recom_shopping0 = new Intent(v.getContext(), ShoppingRecommendedDetail.class);
                            v.getContext().startActivity(intent_recom_shopping0);
                            break;
                        case 1:
                            /*Snackbar.make(list, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                            Intent intent_recom_shopping1 = new Intent(v.getContext(), ShoppingRecommendedDetail.class);
                            v.getContext().startActivity(intent_recom_shopping1);
                            break;
                        case 2:
                            /*Snackbar.make(list, "Position : " + getPosition(), Snackbar.LENGTH_LONG).show();*/
                            Intent intent_recom_shopping2 = new Intent(v.getContext(), ShoppingRecommendedDetail.class);
                            v.getContext().startActivity(intent_recom_shopping2);
                            break;
                    }
                }
            });
